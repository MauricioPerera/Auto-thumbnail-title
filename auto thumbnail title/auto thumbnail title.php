 ...
 */
function activate_auto thumbnail title() {
 ...
 */
function deactivate_auto thumbnail title() {
...
register_activation_hook( __FILE__, 'activate_auto thumbnail title' );
register_deactivation_hook( __FILE__, 'deactivate_auto thumbnail title' );
 ...
 * @since    1.0.0
 */
function run_auto thumbnail title() {

	$plugin = new Auto_Thumbnail_Title();
	$plugin->run();

}
run_auto thumbnail title();
